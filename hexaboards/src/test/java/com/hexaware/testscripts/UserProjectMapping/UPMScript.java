package com.hexaware.testscripts.UserProjectMapping;
...
public class UPMScript {
    ...
    String[] dataArray;
    String username, password, name, email, temp, pname, pname2, description, start_date, end_date, role, usernameRole,description2, start_date2, end_date2, role2, usernameRole2;
