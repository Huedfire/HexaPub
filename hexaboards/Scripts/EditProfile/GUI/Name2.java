...
public class Name2 {
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            ArrayList<String> edit = r.readRows(filepath, 4);
            String name;
            String username;
            String password;
            ...
            for (int i = 1; i < edit.size(); i++) {
                ...
                //Edit user's name
                editName(driver,element,ep,name);
    ...
    public static void editName(WebDriver driver, WebElement element, EditProfile ep, String name){
        WebDriverWait varWat = new WebDriverWait(driver, 40);
        ...
        //Click on unlock name field
        element = ep.getUnlockName();
        varWat.until(ExpectedConditions.elementToBeClickable(element));
        element.click();

        //Type the name value on the name field
        element = ep.getEditName();
        varWat.until(ExpectedConditions.elementToBeClickable(element));
